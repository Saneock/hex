 ...
 * @since 2.0
 */
class Request extends \Abstracts\Request
{
    /**
    ...
    public function resolve()
    {
        ...
        if ($result !== false) {
            ...
            throw new \Exceptions\Http\Client\NotFoundException('Page not found');
        }
    }
    ...
    public function getScriptUrl()
    {
        if ($this->_scriptUrl === null) {
            ...
            if (isset($_SERVER['SCRIPT_NAME']) && basename($_SERVER['SCRIPT_NAME']) === $scriptName) {
                ...
                throw new \Exception\InvalidConfig('Unable to determine the entry script URL.');
            }
        }
    ...
    public function getScriptFile()
    {
        if (isset($this->_scriptFile)) {
            ...
            throw new \Exception\InvalidConfig('Unable to determine the entry script file path.');
        }
    }
    ...
    protected function loadCookies()
    {
        ...
        if ($this->enableCookieValidation) {
            if ($this->cookieValidationKey == '') {
                throw new \Exception\InvalidConfig(get_class($this) . '::cookieValidationKey must be configured with a secret key.');
            }
