...
class CookieCollection extends Object implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     * @throws \Exception\InvalidCall if the cookie collection is read only
     */
    public function add(Cookie $cookie)
    {
        if ($this->readOnly) {
            throw new \Exception\InvalidCall('The cookie collection is read only.');
        }
     ...
     * @throws \Exception\InvalidCall if the cookie collection is read only
     */
    public function remove(Cookie $cookie, $removeFromBrowser = true)
    {
        if ($this->readOnly) {
            throw new \Exception\InvalidCall('The cookie collection is read only.');
        }
